        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("GymUser_Email_Check", "Email LIKE '%_@__%.__%'");
                    table.CheckConstraint("GymUser_Phone_Check", "(Phone LIKE '010%' OR Phone LIKE '011%' OR Phone LIKE '012%' OR Phone LIKE '015%') AND Phone NOT LIKE '%[^0-9]%'");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("GymUser_Email_Check1", "Email LIKE '%_@__%.__%'");
                    table.CheckConstraint("GymUser_Phone_Check1", "(Phone LIKE '010%' OR Phone LIKE '011%' OR Phone LIKE '012%' OR Phone LIKE '015%') AND Phone NOT LIKE '%[^0-9]%'");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("Session_EndTimeCheck", "StartDate < EndDate");
                    table.ForeignKey(
